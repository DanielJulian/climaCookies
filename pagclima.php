...
if(is_null($_SESSION["user"]) && is_null($_SESSION["password"]) ){
	header("location: http://localhost/climaCookies/loginclima.php"); //Para  ir a la otra pagina web
}
...
<head>
    ...
    <script src="galletitas.js"></script>
...
<body>
	...
	<div class='container'>
		...
		<div id="busquedas">
			<textarea name="textarea" id="searches" rows="10" cols="50" disabled placeholder="Aquí se mostrarán los resultados de sus antiguas búsquedas"><?php
			?></textarea>
		</div>
	</div>
</body>
